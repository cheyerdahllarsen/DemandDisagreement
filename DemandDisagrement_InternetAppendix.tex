    ...
    \usepackage{harvard}            % JF style to reference
...
\input{InternetAppendix_TitlePage}
...
\input{InternetAppendix_DemandDisagreementRegressions.tex}
\newpage
\input{InternetAppendix_UKF.tex}
\newpage
\input{InternetAppendix_FilteringExtendedResults.tex}
\newpage
\input{InternetAppendix_AlternativeCalibration.tex}
\newpage
\input{InternetAppendix_AltPars.tex}
\newpage
\input{InternetAppendix_ReverseBias.tex}
\newpage
\input{InternetAppendix_GeneralDisagreement.tex}
\newpage
\input{InternetAppendix_Production.tex}
\newpage
\input{InternetAppendix_WealthShares.tex}
\newpage
\input{InternetAppendix_CorrelationPuzzle.tex}
\newpage
\input{InternetAppendix_PDpredictability.tex}
\newpage
\input{InternetAppendix_Trading.tex}
\newpage
\input{InternetAppendix_BlacksLeverage.tex}
\bibliographystyle{apalike}
\newpage
\bibliography{OLGBeliefs}\label{references}
